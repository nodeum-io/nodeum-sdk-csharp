...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskDestinationDown :  IEquatable<TaskDestinationDown>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskDestinationDown" /> class.
        /// </summary>
        /// <param name="folder">folder.</param>
        /// <param name="container">container.</param>
        /// <param name="tape">tape.</param>
        /// <param name="pool">pool.</param>
        public TaskDestinationDown(NodeumFile folder = default(NodeumFile), Container container = default(Container), Tape tape = default(Tape), Pool pool = default(Pool))
        {
            this.Folder = folder;
        ...
        public NodeumFile Folder { get; set; }
        ...
        {
            return this.Equals(input as TaskDestinationDown);
        }

        /// <summary>
        /// Returns true if TaskDestinationDown instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskDestinationDown to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskDestinationDown input)
        {
            if (input == null)
                return false;
