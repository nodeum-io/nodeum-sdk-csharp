...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BySecondaryBucket : ByDateFacet,  IEquatable<BySecondaryBucket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BySecondaryBucket" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BySecondaryBucket {\n");
        ...
        {
            return this.Equals(input as BySecondaryBucket);
        }

        /// <summary>
        /// Returns true if BySecondaryBucket instances are equal
        /// </summary>
        /// <param name="input">Instance of BySecondaryBucket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BySecondaryBucket input)
        {
            if (input == null)
                return false;
