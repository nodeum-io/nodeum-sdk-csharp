...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ByGroupOwnerFacetAllOf :  IEquatable<ByGroupOwnerFacetAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ByGroupOwnerFacetAllOf);
        }

        /// <summary>
        /// Returns true if ByGroupOwnerFacetAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ByGroupOwnerFacetAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ByGroupOwnerFacetAllOf input)
        {
            if (input == null)
                return false;
