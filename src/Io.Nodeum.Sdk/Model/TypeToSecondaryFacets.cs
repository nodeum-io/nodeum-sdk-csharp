...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TypeToSecondaryFacets :  IEquatable<TypeToSecondaryFacets>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TypeToSecondaryFacets" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TypeToSecondaryFacets);
        }

        /// <summary>
        /// Returns true if TypeToSecondaryFacets instances are equal
        /// </summary>
        /// <param name="input">Instance of TypeToSecondaryFacets to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TypeToSecondaryFacets input)
        {
            if (input == null)
                return false;
