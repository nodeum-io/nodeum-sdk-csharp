...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PoolCollection :  IEquatable<PoolCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolCollection" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PoolCollection);
        }

        /// <summary>
        /// Returns true if PoolCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of PoolCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolCollection input)
        {
            if (input == null)
                return false;
