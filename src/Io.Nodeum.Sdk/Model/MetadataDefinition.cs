...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MetadataDefinition :  IEquatable<MetadataDefinition>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Multitext for value: multi_text
            /// </summary>
            [EnumMember(Value = "multi_text")]
            Multitext = 5
        ...
        public MetadataDefinition(string key = default(string), string name = default(string), bool mandatory = default(bool), TypeEnum? type = default(TypeEnum?), string comment = default(string))
        {
            this.Key = key;
            this.Name = name;
        ...
        {
            return this.Equals(input as MetadataDefinition);
        }

        /// <summary>
        /// Returns true if MetadataDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataDefinition input)
        {
            if (input == null)
                return false;
