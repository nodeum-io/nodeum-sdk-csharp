...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskFacetBucket :  IEquatable<TaskFacetBucket>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TaskFacetBucket);
        }

        /// <summary>
        /// Returns true if TaskFacetBucket instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskFacetBucket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskFacetBucket input)
        {
            if (input == null)
                return false;
