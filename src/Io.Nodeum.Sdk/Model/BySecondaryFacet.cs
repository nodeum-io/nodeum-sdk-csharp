...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BySecondaryFacet :  IEquatable<BySecondaryFacet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BySecondaryFacet" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BySecondaryFacet);
        }

        /// <summary>
        /// Returns true if BySecondaryFacet instances are equal
        /// </summary>
        /// <param name="input">Instance of BySecondaryFacet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BySecondaryFacet input)
        {
            if (input == null)
                return false;
