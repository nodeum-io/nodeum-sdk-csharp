...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiKeyCollection :  IEquatable<ApiKeyCollection>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiKeyCollection(List<ApiKey> apiKeys = default(List<ApiKey>), int count = default(int))
        {
        ...
        {
            return this.Equals(input as ApiKeyCollection);
        }

        /// <summary>
        /// Returns true if ApiKeyCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiKeyCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiKeyCollection input)
        {
            if (input == null)
                return false;
