...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ByFileExtensionFacetAllOf :  IEquatable<ByFileExtensionFacetAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ByFileExtensionFacetAllOf" /> class.
        /// </summary>
        /// <param name="fileExtension">fileExtension.</param>
        public ByFileExtensionFacetAllOf(ByDateFacetBuckets fileExtension = default(ByDateFacetBuckets))
        {
        ...
        {
            return this.Equals(input as ByFileExtensionFacetAllOf);
        }

        /// <summary>
        /// Returns true if ByFileExtensionFacetAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ByFileExtensionFacetAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ByFileExtensionFacetAllOf input)
        {
            if (input == null)
                return false;
