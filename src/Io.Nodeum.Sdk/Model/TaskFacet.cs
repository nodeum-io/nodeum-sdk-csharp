...
namespace Io.Nodeum.Sdk.Model
{
    ...
    public partial class TaskFacet : DefaultFacet,  IEquatable<TaskFacet>, IValidatableObject
    {
        ...
        public TaskFacet(int toProcessSizeSum = default(int), int processedSizeSum = default(int), int toProcessFilesSum = default(int), int processedFilesSum = default(int), int finalizedFilesSum = default(int), int bandwidthAvg = default(int), int count = default(int)) : base()
        {
