...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ByPrimaryFacetAllOf :  IEquatable<ByPrimaryFacetAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ByPrimaryFacetAllOf);
        }

        /// <summary>
        /// Returns true if ByPrimaryFacetAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ByPrimaryFacetAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ByPrimaryFacetAllOf input)
        {
            if (input == null)
                return false;
