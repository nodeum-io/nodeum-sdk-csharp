...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OnTapesFile :  IEquatable<OnTapesFile>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OnTapesFile" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OnTapesFile);
        }

        /// <summary>
        /// Returns true if OnTapesFile instances are equal
        /// </summary>
        /// <param name="input">Instance of OnTapesFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OnTapesFile input)
        {
            if (input == null)
                return false;
