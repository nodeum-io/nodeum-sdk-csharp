...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ByGroupOwnerFacet : FileFacet,  IEquatable<ByGroupOwnerFacet>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ByGroupOwnerFacet);
        }

        /// <summary>
        /// Returns true if ByGroupOwnerFacet instances are equal
        /// </summary>
        /// <param name="input">Instance of ByGroupOwnerFacet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ByGroupOwnerFacet input)
        {
            if (input == null)
                return false;
