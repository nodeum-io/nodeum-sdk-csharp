...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrimaryScan :  IEquatable<PrimaryScan>, IValidatableObject
    {
        /// <summary>
        /// Defines Unit
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PrimaryScan" /> class.
        /// </summary>
        /// <param name="poolId">poolId.</param>
        /// <param name="enabled">enabled.</param>
        /// <param name="operand">operand.</param>
        /// <param name="unit">unit.</param>
        public PrimaryScan(int poolId = default(int), bool enabled = default(bool), decimal operand = default(decimal), UnitEnum? unit = default(UnitEnum?))
        {
            this.PoolId = poolId;
        ...
        {
            return this.Equals(input as PrimaryScan);
        }

        /// <summary>
        /// Returns true if PrimaryScan instances are equal
        /// </summary>
        /// <param name="input">Instance of PrimaryScan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrimaryScan input)
        {
            if (input == null)
                return false;
