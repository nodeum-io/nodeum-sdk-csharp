...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ByDateFacetBucket : ByDateFacet,  IEquatable<ByDateFacetBucket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ByDateFacetBucket" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ByDateFacetBucket {\n");
        ...
        {
            return this.Equals(input as ByDateFacetBucket);
        }

        /// <summary>
        /// Returns true if ByDateFacetBucket instances are equal
        /// </summary>
        /// <param name="input">Instance of ByDateFacetBucket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ByDateFacetBucket input)
        {
            if (input == null)
                return false;
