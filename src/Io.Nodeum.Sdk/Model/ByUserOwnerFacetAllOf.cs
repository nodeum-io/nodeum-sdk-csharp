...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ByUserOwnerFacetAllOf :  IEquatable<ByUserOwnerFacetAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ByUserOwnerFacetAllOf);
        }

        /// <summary>
        /// Returns true if ByUserOwnerFacetAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ByUserOwnerFacetAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ByUserOwnerFacetAllOf input)
        {
            if (input == null)
                return false;
