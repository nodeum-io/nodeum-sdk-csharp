...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImportFile :  IEquatable<ImportFile>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        {
            return this.Equals(input as ImportFile);
        }

        /// <summary>
        /// Returns true if ImportFile instances are equal
        /// </summary>
        /// <param name="input">Instance of ImportFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportFile input)
        {
            if (input == null)
                return false;
