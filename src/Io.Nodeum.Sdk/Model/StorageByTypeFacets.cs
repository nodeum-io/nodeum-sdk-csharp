...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StorageByTypeFacets :  IEquatable<StorageByTypeFacets>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageByTypeFacets" /> class.
        /// </summary>
        ...
        public StorageByTypeFacets(DefaultFacet container = default(DefaultFacet), StorageNasShareFacets nasShare = default(StorageNasShareFacets), StorageCloudBucketFacets cloudBucket = default(StorageCloudBucketFacets), StorageTapeFacets tape = default(StorageTapeFacets), StoragePoolFacets pool = default(StoragePoolFacets))
        {
        ...
        {
            return this.Equals(input as StorageByTypeFacets);
        }

        /// <summary>
        /// Returns true if StorageByTypeFacets instances are equal
        /// </summary>
        /// <param name="input">Instance of StorageByTypeFacets to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StorageByTypeFacets input)
        {
            if (input == null)
                return false;
