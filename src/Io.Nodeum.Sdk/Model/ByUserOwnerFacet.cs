...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ByUserOwnerFacet : FileFacet,  IEquatable<ByUserOwnerFacet>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ByUserOwnerFacet);
        }

        /// <summary>
        /// Returns true if ByUserOwnerFacet instances are equal
        /// </summary>
        /// <param name="input">Instance of ByUserOwnerFacet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ByUserOwnerFacet input)
        {
            if (input == null)
                return false;
