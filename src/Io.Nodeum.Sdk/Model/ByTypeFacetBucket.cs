...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ByTypeFacetBucket :  IEquatable<ByTypeFacetBucket>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ByTypeFacetBucket {\n");
        ...
        {
            return this.Equals(input as ByTypeFacetBucket);
        }

        /// <summary>
        /// Returns true if ByTypeFacetBucket instances are equal
        /// </summary>
        /// <param name="input">Instance of ByTypeFacetBucket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ByTypeFacetBucket input)
        {
            if (input == null)
                return false;
