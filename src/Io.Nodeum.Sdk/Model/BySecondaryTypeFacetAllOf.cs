...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BySecondaryTypeFacetAllOf :  IEquatable<BySecondaryTypeFacetAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BySecondaryTypeFacetAllOf);
        }

        /// <summary>
        /// Returns true if BySecondaryTypeFacetAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of BySecondaryTypeFacetAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BySecondaryTypeFacetAllOf input)
        {
            if (input == null)
                return false;
