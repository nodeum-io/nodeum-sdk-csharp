...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskFacetAllOf :  IEquatable<TaskFacetAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskFacetAllOf" /> class.
        /// </summary>
        ...
        public TaskFacetAllOf(int toProcessSizeSum = default(int), int processedSizeSum = default(int), int toProcessFilesSum = default(int), int processedFilesSum = default(int), int finalizedFilesSum = default(int), int bandwidthAvg = default(int))
        {
        ...
        {
            return this.Equals(input as TaskFacetAllOf);
        }

        /// <summary>
        /// Returns true if TaskFacetAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskFacetAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskFacetAllOf input)
        {
            if (input == null)
                return false;
