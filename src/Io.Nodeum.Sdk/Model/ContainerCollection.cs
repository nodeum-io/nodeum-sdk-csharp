...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContainerCollection :  IEquatable<ContainerCollection>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContainerCollection {\n");
        ...
        {
            return this.Equals(input as ContainerCollection);
        }

        /// <summary>
        /// Returns true if ContainerCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of ContainerCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContainerCollection input)
        {
            if (input == null)
                return false;
