...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ByPrimaryFacet : FileFacet,  IEquatable<ByPrimaryFacet>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ByPrimaryFacet);
        }

        /// <summary>
        /// Returns true if ByPrimaryFacet instances are equal
        /// </summary>
        /// <param name="input">Instance of ByPrimaryFacet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ByPrimaryFacet input)
        {
            if (input == null)
                return false;
