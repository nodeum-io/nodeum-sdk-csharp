...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ByPrimaryTypeFacet :  IEquatable<ByPrimaryTypeFacet>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ByPrimaryTypeFacet);
        }

        /// <summary>
        /// Returns true if ByPrimaryTypeFacet instances are equal
        /// </summary>
        /// <param name="input">Instance of ByPrimaryTypeFacet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ByPrimaryTypeFacet input)
        {
            if (input == null)
                return false;
