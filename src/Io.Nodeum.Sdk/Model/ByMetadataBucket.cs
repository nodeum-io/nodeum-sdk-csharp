...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ByMetadataBucket : ByDateFacet,  IEquatable<ByMetadataBucket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ByMetadataBucket" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ByMetadataBucket {\n");
        ...
        {
            return this.Equals(input as ByMetadataBucket);
        }

        /// <summary>
        /// Returns true if ByMetadataBucket instances are equal
        /// </summary>
        /// <param name="input">Instance of ByMetadataBucket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ByMetadataBucket input)
        {
            if (input == null)
                return false;
