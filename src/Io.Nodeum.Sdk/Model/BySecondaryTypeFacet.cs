...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BySecondaryTypeFacet : ByDateFacet,  IEquatable<BySecondaryTypeFacet>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BySecondaryTypeFacet);
        }

        /// <summary>
        /// Returns true if BySecondaryTypeFacet instances are equal
        /// </summary>
        /// <param name="input">Instance of BySecondaryTypeFacet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BySecondaryTypeFacet input)
        {
            if (input == null)
                return false;
