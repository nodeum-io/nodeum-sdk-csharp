...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskFacetMetadataBucket :  IEquatable<TaskFacetMetadataBucket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskFacetMetadataBucket" /> class.
        /// </summary>
        /// <param name="val">val.</param>
        public TaskFacetMetadataBucket(string val = default(string))
        {
            this.Val = val;
        }
        ...
        {
            return this.Equals(input as TaskFacetMetadataBucket);
        }

        /// <summary>
        /// Returns true if TaskFacetMetadataBucket instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskFacetMetadataBucket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskFacetMetadataBucket input)
        {
            if (input == null)
                return false;
