...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ByTaskStatusFacet : TaskFacet,  IEquatable<ByTaskStatusFacet>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ByTaskStatusFacet {\n");
        ...
        {
            return this.Equals(input as ByTaskStatusFacet);
        }

        /// <summary>
        /// Returns true if ByTaskStatusFacet instances are equal
        /// </summary>
        /// <param name="input">Instance of ByTaskStatusFacet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ByTaskStatusFacet input)
        {
            if (input == null)
                return false;
