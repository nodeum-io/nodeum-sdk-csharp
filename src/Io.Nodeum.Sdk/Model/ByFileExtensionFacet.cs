...
namespace Io.Nodeum.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ByFileExtensionFacet : FileFacet,  IEquatable<ByFileExtensionFacet>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ByFileExtensionFacet);
        }

        /// <summary>
        /// Returns true if ByFileExtensionFacet instances are equal
        /// </summary>
        /// <param name="input">Instance of ByFileExtensionFacet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ByFileExtensionFacet input)
        {
            if (input == null)
                return false;
